...
class TransactionScriptPy(unittest.TestCase):
    ...
    def test_transaction_script_py(self):
        ...
        driver.find_element_by_xpath("//*[@id=\"lgusuario\"], psouto").clear()
        driver.find_element_by_xpath("//*[@id=\"lgusuario\"], psouto").send_keys("")
        driver.find_element_by_xpath("//*[@id=\"lgsenha\"], M*02052018h").clear()
        driver.find_element_by_xpath("//*[@id=\"lgsenha\"], M*02052018h").send_keys("")
